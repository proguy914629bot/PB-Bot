...
class CustomHelpCommand(commands.HelpCommand):
    ...
    async def send_command_help(self, command):
        ...
        embed.add_field(name="Are you able to use this command:", value=bot.emoji_dict['green_tick'] if await command.can_run(self.context) else bot.emoji_dict['red_tick'])
    ...
    async def send_group_help(self, group):
        ...
        embed.add_field(name="Are you able to use this command:", value=bot.emoji_dict['green_tick'] if await group.can_run(self.context) else bot.emoji_dict['red_tick'])
        embed.add_field(name="Aliases:", value=aliases, inline=False)
